document.addEventListener("DOMContentLoaded",()=>{let t=document.createElement("style");t.innerHTML=`
    #DRAG-SEARCH{position:fixed;z-index:3;padding:.5rem 1rem;display:none;border-radius:1rem;background-color:var(--md-default-bg-color);border:1px solid var(--md-primary-fg-color);transition-property:top,right,bottom,left;transition-duration:.25s}
    ...
    #DRAG-SEARCH li:not(:last-child){border-right:1px solid darkgray;padding-right:1rem}
