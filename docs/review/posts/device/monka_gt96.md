...
2024년 9월 14일에 주문했기 때문에 추석 연휴와 겹쳐 다소 늦게 배송될 줄 알았는데요, 연휴가 끝나자마자 빠르게 출발되어서 20일 날 수령 받을 수 있었습니다.
...
게임 컨트롤러에서 LED 기능을 지원하는 데 무선 사용 시 배터리를 좀 사용할 걸로 보입니다. 이 부분에서 배터리 용량은 다소 아쉽습니다.
